...
class CandidateEvaluation(models.Model):
    ...
    candidate_name = fields.Char(string='Candidat')
    ...
    tech_competence_develop = fields.Integer(string='Points à développer (Compétences techniques)')
    ...
    analysis_capacity_points = fields.Integer(string='Points forts (Capacité d\'analyse)')
    analysis_capacity_develop = fields.Integer(string='Points à développer (Capacité d\'analyse)')
